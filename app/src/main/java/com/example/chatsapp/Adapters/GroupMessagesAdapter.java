...
import com.example.chatsapp.databinding.ItemReciveGroupBinding;
...
public class GroupMessagesAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        ReactionPopup popup = new ReactionPopup(context, config, (pos) -> {
            ...
            return true; // true is closing popup, false is requesting a new selectionis closing popup, false is requesting a new selection
        });
